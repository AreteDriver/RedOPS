...
class FeatureFlag:
    ...
    def evaluate(self, context: Optional[FlagContext] = None) -> Any:
    ...
    def is_enabled(self, context: Optional[FlagContext] = None) -> bool:
...
class Experiment:
    ...
    def get_variant(self, context: FlagContext) -> Optional[Variant]:
