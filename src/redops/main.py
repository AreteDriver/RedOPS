...
def run_pipeline(pipeline_path: str, target: str, output_dir: str = "./output", config_path: str = None):
    """
...
Examples:
  ...
  redops list
    ...
    list_parser.add_argument('--dir', default='./config/pipelines', help='Pipeline directory')
