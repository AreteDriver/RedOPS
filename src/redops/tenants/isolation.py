...
class TenantIsolation:
    ...
    @staticmethod
    def get_tenant_prefix(tenant: Optional[Tenant] = None) -> str:
        """
    ...
    @staticmethod
    def scope_key(key: str, tenant: Optional[Tenant] = None) -> str:
        """
...
class TenantDataStore(Generic[T]):
    ...
    def _get_tenant_id(self, tenant: Optional[Tenant] = None) -> str:
...
class IsolatedStorage:
    ...
    def get_tenant_root(self, tenant: Optional[Tenant] = None) -> Path:
        """
    ...
    def get_usage(self, tenant: Optional[Tenant] = None) -> Dict[str, Any]:
        """
...
class TenantAwareCache:
    ...
    def _get_scoped_key(self, key: str, tenant: Optional[Tenant] = None) -> str:
    ...
    def clear_tenant(self, tenant: Optional[Tenant] = None) -> int:
        """
