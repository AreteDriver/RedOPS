...
**Defensive security assessment framework — OSINT reconnaissance, metadata forensics, threat modeling, and attack surface analysis for authorized security evaluations.**
